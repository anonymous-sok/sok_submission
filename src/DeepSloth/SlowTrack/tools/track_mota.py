...
def make_parser():
    ...
    parser.add_argument("--max_det", type=int, default=500, help="the frames for keep lost tracks")
...
def main(exp, args, num_gpu):
    ...
    import pickle
    with open("clean_run_data.pkl", "rb") as f:
        loaded_data = pickle.load(f)
        
    # import pdb; pdb.set_trace()
    *_, summary = evaluator.evaluate_with_accuracy(
            model, is_distributed, args.fp16, trt_file, decoder, exp.test_size, gt_data=loaded_data
        )
